...
<body>
	...
	<div id="header">
		...
		<div id="nav">
			<ul>
				<li><a href="/AntStore2/index.jsp">首页</a></li>
				<li><a href="/AntStore2/GoodsServlet">电脑办公</a></li>
				<li><a href="/AntStore2/GoodsServlet">家具家居</a></li>
				<li><a href="/AntStore2/GoodsServlet">鲜果时光</a></li>
				<li><a href="/AntStore2/GoodsServlet">图书音像</a></li>
				<li><a href="/AntStore2/GoodsServlet">母婴孕婴</a></li>
			</ul>
		</div>
