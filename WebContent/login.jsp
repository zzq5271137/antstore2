...
<div class="login_body">
    ...
    <div class="login_center">
        ...
        <div class="login_bg">
            <h4>忘记密码</h4>
            <form action="/AntStore2/LoginServlet"  id="login" method="post">
                <!--用户名-->
               <div class="username"><span></span><input type="text" placeholder="请输入用户名" name="username"></div>
                <!--密码-->
                <div class="password"><span></span><input type="text" placeholder="请输入密码" name="password"></div>
                <div class="login_btn"><input type="submit" class="login_btn" value="登录"></div>
            </form>
            <div class="forgotPwd"><!--忘记密码-->
                <a href="">忘记密码</a> <a href="">忘记会员名</a> <a href="/AntStore2/regist.jsp">免费注册</a>
            </div>
        </div>
    </div>
</div>
